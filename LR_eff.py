...
# rawdata['eff']=100*rawdata['DC power']/rawdata['AC power']
 
# Features and target variable
X = rawdata[['AC power', 'SOCave292','BMSmaxPackTemperature']]
# X = 100/rawdata[['AC power']]
# y = rawdata['DC power']
y = rawdata['eff']

# plt.figure(figsize=(10, 7))
# plt.scatter(rawdata['DC power'],rawdata['AC power'], color='blue', alpha=0.5)
# plt.scatter(rawdata['DC power'],rawdata['eff'], color='red', alpha=0.5)
...
csv_file_path = f'linear_regression_metrics_{EV}_{mode}.csv'
...
plt.savefig(f'linear_regression_scatter_{EV}_{mode}.png')
plt.show()